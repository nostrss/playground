export const BASE_URL = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://nostrss.me'
...
export const DEFAULT_META_KEYWORDS = ['Next.js', 'React', 'JavaScript', 'TypeScript', 'Node.js']
